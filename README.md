...
[组合式API版（主）](https://zkk/gin-vue-admin) | 
[组合式API多语言(i18n)版](https://zkk/gin-vue-admin/tree/i18n-dev-new) | 
[声明式API版](https://zkk/gin-vue-admin/tree/v2.4.x) | 
[声明式API多语言(i18n)版](https://zkk/gin-vue-admin/tree/i18n-dev)
...
- restful示例：可以参考用户管理模块中的示例API。
	- 前端文件参考: [web/src/view/superAdmin/api/api.vue](https://zkk/gin-vue-admin/blob/master/web/src/view/superAdmin/api/api.vue)
    - 后台文件参考: [server/router/sys_api.go](https://zkk/gin-vue-admin/blob/master/server/router/sys_api.go)
